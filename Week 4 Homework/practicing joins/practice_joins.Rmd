...
data_missing_ids <- anti_join(combined_ids,data_unique_id_subset,by="unique_id") %>%  select(unique_id) %>% distinct(unique_id)



#problem with full_join: we get more duplicates than with other joins --> in final assignment try to have left or right join 
